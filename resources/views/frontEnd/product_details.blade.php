            ...
            <div class="col-sm-7">
                <form action="{{route('addToCart')}}" method="post" role="form">
                    ...
                    <div class="product-information"><!--/product-information-->
                        ...
                        <span>
                            <span id="dynamic_price">{{$detail_product->price}} VND</span>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <p>{{$item->p_name}}</p>
                                                <button  type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Xem sản phẩm</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
