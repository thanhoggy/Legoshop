...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Trang chủ</a> <a href="{{route('product.index')}}">Sản phẩm</a> <a href="{{route('product.create')}}" class="current">Add New Product</a> </div>
