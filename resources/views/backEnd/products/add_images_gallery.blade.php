...
@section('title','Thêm ảnh SP')
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Trang chủ</a> <a href="{{route('product.index')}}">Sản phẩm</a> <a href="#" class="current">Thêm ảnh</a> </div>
                        ...
                        <ul class="recent-posts">
                            ...
                            <li>
                                <form action="{{route('image-gallery.store')}}" method="post" role="form" enctype="multipart/form-data">
                                    <legend>Bạn có thể thêm nhiều hình ảnh</legend>
                            ...
                            <?php $i=1; ?>
                                @foreach($imageGalleries as $imageGallery)
                                    <tr>
                                        ...
                                        <td style="text-align: center;vertical-align: middle;"><a href="javascript:" rel="{{$imageGallery->id}}" rel1="delete-imageGallery" class="btn btn-danger btn-mini deleteRecord">Xóa</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
