...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Trang chủ</a> <a href="{{route('product.index')}}">Sản phẩm</a> <a href="#" class="current">Add Attribute</a> </div>
                            ...
                            <ul class="recent-posts">
                                <li>
                                    ...
                                    <div class="article-post">
                                        <span class="user-info">Mã sản phẩm : <b>{{$product->p_code}}</b></span>
                                        <p>Màu sắc : <b>{{$product->p_color}}</b></p>
                                    </div>
                                </li>
                                <li>
                                    <form action="{{route('product_attr.store')}}" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="sku" value="{{old('sku')}}" id="sku" placeholder="Mã SP" required>
                                            <input type="text" class="form-control" name="size" value="{{old('size')}}" id="size" placeholder="Kích thước" required>
                                            <input type="text" class="form-control" name="price" value="{{old('price')}}" id="price" placeholder="Giá" required>
                                            <span style="color: red;">{{$errors->first('price')}}</span>
                                            <input type="number" class="form-control" name="stock" value="{{old('stock')}}" id="stock" placeholder="Số lượng" required>
                                        </div>
                            ...
                            <form action="{{route('product_attr.update',$product->id)}}" method="post" role="form">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; ">
                                        ...
                                        <a href="javascript:" rel="{{$attribute->id}}" rel1="delete-attribute" class="btn btn-danger btn-mini deleteRecord">Xóa</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
