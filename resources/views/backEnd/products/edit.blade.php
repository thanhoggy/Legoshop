...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Trang chủ</a> <a href="{{route('product.index')}}">Sản phẩm</a> <a href="#" class="current">Edit Product</a> </div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{route('product.update',$edit_product->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <label for="p_color" class="control-label">Mau sắc</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            @if($edit_product->image!='')
                                &nbsp;&nbsp;&nbsp;
                                <a href="javascript:" rel="{{$edit_product->id}}" rel1="delete-image" class="btn btn-danger btn-mini deleteRecord">Xóa ảnh cũ</a>
