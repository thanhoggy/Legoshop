            ...
            <div class="widget-content nopadding">
                <form action="{{route('coupon.update',$edit_coupons->id)}}" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="coupon_code" class="control-label">Mã KM</label>
                    ...
                    <div class="control-group">
                        <label for="amount" class="control-label">Giá trị</label>
                    ...
                    <div class="control-group">
                        <label for="amount_type" class="control-label">Loại mã</label>
                    ...
                    <div class="control-group">
                        <label for="expiry_date" class="control-label">Ngày hết hạn</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Cập nhật mã KM</button>
                        </div>
                    </div>
                </form>
            </div>
