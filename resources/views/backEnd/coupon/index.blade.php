                    ...
                    @foreach($coupons as $coupon)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                {{$coupon->status==1?'Kích hoạt':'Hủy kích hoạt'}}
                            </td>
                            <td style="text-align: center; vertical-align: middle;">
                                <a href="{{route('coupon.edit',$coupon->id)}}" class="btn btn-primary btn-mini">Sửa</a>
                                <a href="javascript:" rel="{{$coupon->id}}" rel1="delete-coupon" class="btn btn-danger btn-mini deleteRecord">Xóa</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
