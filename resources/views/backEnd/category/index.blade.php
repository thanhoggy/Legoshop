                    ...
                    <tbody>
                        @foreach($categories as $category)
                            ...
                            <tr class="gradeC">
                                ...
                                <td style="text-align: center;">{{($category->status==0)?' Chưa kích hoạt':'Kích hoạt'}}</td>
                                <td style="text-align: center;">
                                    <a href="{{route('category.edit',$category->id)}}" class="btn btn-primary btn-mini">Sửa</a>
                                    <a href="javascript:" rel="{{$category->id}}" rel1="delete-category" class="btn btn-danger btn-mini deleteRecord">Xóa</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
...
@section('jsblock')
    ...
    <script>
        $(".deleteRecord").click(function () {
           ...
           swal({
               title:'Bạn chắc chứ?',
               text:"Bạn sẽ không thể quay lại nếu làm điều này!",
               type:'warning',
